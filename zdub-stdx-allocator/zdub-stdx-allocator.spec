...
%define lib_name      stdx-allocator
%define lib_ver       2.77.5
%define lib_gitver    2.77.5
%define lib_semver    2.77.5
%define lib_dist      0
...
Source0:        https://github.com/wilzbach/stdx-allocator/archive/refs/tags/v%{lib_gitver}/stdx-allocator-%{lib_gitver}.tar.gz
Source1:        LICENSE
