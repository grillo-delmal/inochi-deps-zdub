...
%define lib_name      diet-ng
%define lib_ver       1.8.1
%define lib_gitver    1.8.1
%define lib_semver    1.8.1
%define lib_dist      0
...
Source0:        https://github.com/rejectedsoftware/diet-ng/archive/v%{lib_gitver}/diet-ng-%{lib_gitver}.tar.gz
