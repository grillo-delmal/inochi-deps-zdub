...
%define lib_name      tinyfiledialogs
%define lib_ver       0.10.1
%define lib_gitver    0.10.1
%define lib_semver    0.10.1
%define lib_dist      0
...
Source0:        https://github.com/dayllenger/tinyfiledialogs-d/archive/refs/tags/v%{lib_gitver}/tinyfiledialogs-d-%{lib_gitver}.tar.gz
...
%prep
%autosetup -n tinyfiledialogs-d-%{lib_gitver} -p1
