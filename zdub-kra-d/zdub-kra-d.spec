...
%define lib_ver       0.5.5+build.3.g25453ad
%define lib_gitver    0.5.5+build.3.g25453ad
%define lib_semver    0.5.5+build.3.g25453ad
%define lib_dist      0
...
Source0:        https://github.com/Inochi2D/kra-d/archive/%{kra_d_commit}/kra-d-%{kra_d_short}.tar.gz
