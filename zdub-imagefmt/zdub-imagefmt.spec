...
%define lib_name      imagefmt
%define lib_ver       2.1.2
%define lib_gitver    2.1.2
%define lib_semver    2.1.2
%define lib_dist      0
...
Source0:        https://github.com/tjhann/imagefmt/archive/refs/tags/v%{lib_gitver}/imagefmt-%{lib_gitver}.tar.gz
